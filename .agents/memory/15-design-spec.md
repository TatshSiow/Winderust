...
- Delete opens confirmation for the selected process or stack members only, without descendants. Tree termination remains an explicit context-menu action; Cancel submits no termination.
