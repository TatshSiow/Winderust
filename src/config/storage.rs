    ...
    fn toml_round_trip_preserves_settings() {
        let settings = Settings {
            ...
            foreground_responsiveness: ForegroundResponsivenessSettings {
                ...
                auto_balance_io_priority: IoPrioritySettings::default(),
                auto_balance_thread_priority: crate::config::ThreadPrioritySettings::default(),
                auto_balance_priority_boost: PriorityBoostSettings::default(),
                auto_balance_gpu_priority: GpuPrioritySettings::default(),
